      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <Link to="/" className="inline-block mb-4">
                <img
                  src="https://res.cloudinary.com/dfrbkwdzf/image/upload/q_auto/f_auto/v1779357372/KNIGHTS-ENERGY-LOGO_d1cy8j_m0ljhz.png"
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-end">
              <a
                href="https://play.google.com/store/apps/details?id=com.namp.echarge"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-base text-gray-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.facebook.com/knightsenergy" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#36AC43] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </a>
            <a href="https://www.linkedin.com/company/knightsenergyke/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#36AC43] transition-colors">
