...
export function Home() {
  ...
  const [selectedEcoHubItem, setSelectedEcoHubItem] = useState<number | null>(null);
  const projects = [
    { name: "Missionary Benedictine Karen", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1726221062287-fda475b85493?w=800" },
    { name: "Standard Chartered Bank HQ", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1629726797843-618688139f5a?w=800" },
    { name: "Megapack", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1774927334511-c2d1cf654b08?w=800" },
    { name: "IBER Africa", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1670519808728-335b1eb2ef52?w=800" },
    { name: "Daughters of Charity", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1776918570438-886f538edd93?w=800" },
    { name: "BAT Thika", category: "Solar, Projects", image: "https://images.unsplash.com/photo-1771178301028-49a922aefccd?w=800" },
  ];
  ...
  const ecoHubItems = [
    {
      ...
      content: {
        description: "Energy costs represent one of the largest operational expenses for businesses across East Africa. Our Eco-Hub concept delivers measurable cost reductions through intelligent energy management and solar-powered infrastructure.",
        benefits: [
    ...
    },
    {
      ...
      content: {
        description: "Knights Energy brings together three critical areas of expertise—solar energy generation, intelligent energy management, and electric mobility—to deliver integrated solutions that maximize efficiency and sustainability.",
        benefits: [
    ...
    },
    {
      ...
      content: {
        description: "Climate change demands urgent action. Our Eco-Hub concept helps businesses meet sustainability goals while positioning them as environmental leaders in their industries.",
        benefits: [
    ...
    },
    {
      ...
      content: {
        description: "Technical excellence underpins every Eco-Hub installation. Our systematic approach ensures optimal performance, reliability, and long-term value for every client.",
        benefits: [
  ...
  return (
    <div className="w-full">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4)), url('https://images.unsplash.com/photo-1726221062287-fda475b85493?w=1600')`,
        }}
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-24 text-white w-full">
          <div className="max-w-3xl">
            <p className="text-base font-semibold uppercase tracking-widest mb-6" style={{ color: '#36AC43' }}>
              Complete Commercial, Residential & Industrial Solar Systems
            </p>
            <h1 className="text-5xl lg:text-6xl font-bold mb-8 leading-tight">
              Home of Renewable<br />Energy and Electrical<br />Contracting!
            </h1>
            <p className="text-2xl lg:text-3xl mb-12 text-gray-200 leading-relaxed">
              All our energy is generated from renewable sources. We will help you to reduce your energy consumption.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <AnimatedSection animation="fade-right">
              ...
              <img
                src="https://images.unsplash.com/photo-1726221062299-88f27b653c59?w=800"
            ...
            <AnimatedSection animation="fade-left" delay={200}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                We are committed to providing alternative solutions of the highest standards and address the energy cost factor.
              </p>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Over the years, the Company has become one of the biggest installers and maintenance partners for medium and large-scale solar installations in the region with a considerable number of solutions for domestic and Industrial projects. We are also the leading clean mobility consultants in East Africa, specializing in eMobility.
              </p>
              <button
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <p className="text-xl text-gray-600 text-center max-w-5xl mx-auto mb-16 leading-relaxed">
            Our expertise covers Energy generation, energy management and electric mobility which leads to generation, consumption monitoring and reporting on energy usage and efficiency. Our Reference Projects are testament to our success in delivering world-class solar power plants to leading investors in the PV sector. We work to provide options that meet the specific customer needs and are consistent with ensuring Environmental Sustainability.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="bg-gradient-to-br from-[#36AC43] to-[#2d8c36] text-white p-10 rounded-3xl mb-10 shadow-2xl">
                ...
                <p className="text-xl leading-relaxed">Customer Satisfaction based on 750+ reviews and 6,154 Completed Projects.</p>
              </div>
              <Link
                to="/services"
            ...
            <div className="relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1774542916400-77f2dd1744d7?w=800"
          ...
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-bold mb-6 text-gray-900">
                Wide variety of solutions in<br />Power & IT Industry
              </h2>
            </div>
          </AnimatedSection>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Feasibility Studies", subtitle: "For Commercial & Industrial Clients" },
              ...
              <AnimatedSection key={index} animation="fade-up" delay={index * 100}>
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-[#36AC43] transition-colors">{service.title}</h3>
                <p className="text-gray-600 text-xl leading-relaxed">{service.subtitle}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 text-gray-900">Latest Projects</h2>
              <p className="text-xl text-gray-600">Showcasing excellence in solar energy implementation</p>
            </div>
          </AnimatedSection>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-8 leading-tight">The Eco-Hub Concept</h2>
              <p className="text-2xl mb-8 text-gray-200">
                Revolutionizing Transport and Achieving Energy Security
              </p>
              <p className="text-xl text-gray-300 mb-12 leading-relaxed">
                We are proud to be pioneering the ECOHUB CONCEPT. A development of an integrated electro mobility ecosystem powered by solar implemented across various transport models resulting in a magnitude of energy and cost saving as well as environmental benefits.
              </p>
              <Link
                to="/projects"
            ...
            <div className="grid grid-cols-2 gap-6">
              {ecoHubItems.map((item, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-2">
                  <h3 className="text-2xl font-bold mb-4 text-white">{item.title}</h3>
                  <p className="text-gray-300 mb-6 leading-relaxed text-lg">{item.desc}</p>
                  <button
                    onClick={() => {
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid md:grid-cols-2 gap-10 items-stretch">
            <AnimatedSection animation="fade-right">
              ...
              <p className="text-2xl font-semibold mb-8 leading-tight">Number Of Projects In Operations Across East Africa</p>
            ...
            <AnimatedSection animation="fade-left" delay={200}>
              ...
              <p className="text-2xl font-semibold mb-8 leading-tight">Years Of Experience On Renewable Energy</p>
              <p className="text-xl mb-10 text-gray-200 leading-relaxed">
                We embrace change and are thriving, building better, long lasting and more reliable solar solutions.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link to="/about#team" className="px-8 py-4 bg-[#36AC43] text-white rounded-md hover:bg-[#2d8c36] font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-lg">
                  Our Leadership Team
                </Link>
                <Link to="/about#careers" className="px-8 py-4 border-2 border-white text-white rounded-md hover:bg-white hover:text-gray-900 font-semibold transition-all duration-300 text-lg">
                  Join Our Team
                </Link>
              </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="bg-white p-12 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2">
              <h3 className="text-3xl font-bold mb-6 text-gray-900">Design & Shipping</h3>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                We strive to produce unique designs, give the best solutions that match your needs and select the appropriate equipment at the appropriate moment.
              </p>
            ...
            <div className="bg-white p-12 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2">
              <h3 className="text-3xl font-bold mb-6 text-gray-900">Contract & Install</h3>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                If you choose self-installation, our organization will provide you with competitive and adaptable contracts to fit your management requirements.
              </p>
              <button className="px-10 py-4 bg-gradient-to-r from-[#36AC43] to-[#2d8c36] text-white rounded-xl hover:shadow-2xl transition-all duration-300 font-bold text-xl transform hover:-translate-y-1">
                Request A Quote
              </button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-gradient-to-br from-[#36AC43] to-[#2d8c36] text-white p-12 lg:p-16 rounded-3xl shadow-2xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-xl">Reduce your energy bills by up to 80%</p>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-8 h-8 text-white flex-shrink-0" />
                  <p className="text-xl">Environmentally friendly & sustainable</p>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-8 h-8 text-white flex-shrink-0" />
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-xl text-gray-600">Get a customized solar solution for your needs</p>
              </div>
              <form className="bg-white p-8 lg:p-10 rounded-3xl shadow-2xl space-y-6">
                ...
                <div>
                  <label className="block text-gray-700 font-semibold mb-4 text-xl">Preferred Contact Method</label>
                  <div className="flex gap-6">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input type="radio" name="contact" value="all" className="w-5 h-5 text-[#36AC43]" defaultChecked />
                      <span className="text-gray-700 text-lg">All</span>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input type="radio" name="contact" value="email" className="w-5 h-5 text-[#36AC43]" />
                      <span className="text-gray-700 text-lg">Email</span>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input type="radio" name="contact" value="phone" className="w-5 h-5 text-[#36AC43]" />
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <AnimatedSection animation="fade-up">
            <h2 className="text-4xl font-bold mb-16 text-center text-gray-900">Trusted by Leading Organizations</h2>
          </AnimatedSection>
      ...
      <EcoHubModal
        ...
        title={selectedEcoHubItem !== null ? ecoHubItems[selectedEcoHubItem].title : ""}
        content={selectedEcoHubItem !== null ? ecoHubItems[selectedEcoHubItem].content : { description: "", benefits: [], details: [] }}
      />
    </div>
  );
}
