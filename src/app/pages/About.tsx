		...
		<div className="w-full">
			...
			<section className="py-12 sm:py-24 bg-white">
				<div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
					<div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center mb-12 sm:mb-24">
						<AnimatedSection animation="fade-right">
							<div className="relative">
								...
								<img
									...
									className="rounded-3xl shadow-2xl w-full h-[300px] md:h-[500px] object-cover relative z-10"
								/>
						...
						<AnimatedSection animation="fade-left" delay={200}>
							<div>
								<h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-gray-900 leading-tight">
					...
					{/* Quick Links Grid */}
					<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10" id="advantage">
						<Link
							to="#advantage"
							className="bg-white p-6 sm:p-10 rounded-3xl hover:shadow-2xl transition-all duration-300 shadow-lg transform hover:-translate-y-2 border border-gray-100 group">
							...
							<h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 text-gray-900 group-hover:text-[#36AC43] transition-colors">
			...
			<section className="py-12 sm:py-24 bg-gray-50" id="team">
				<div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
			...
			{/* Awards Section */}
			<section className="py-12 sm:py-16 bg-white" id="awards">
				<div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
						{[
							...
							<div
								...
								<h3 className="text-lg sm:text-xl font-bold text-gray-900">{award}</h3>
							</div>
						))}
					</div>
				</div>
			...
			{/* Careers Section */}
			<section
				className="py-12 sm:py-24 bg-gradient-to-br from-[#36AC43] to-[#2d8c36]"
				id="careers">
				<div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
					<div className="text-center mb-12 sm:mb-16 text-white">
						<h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6">Join Our Team</h2>
						<p className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed text-white/90">
							...
							<div key={index} className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col h-full text-left">
								...
								<div className="space-y-3 mb-6">
									<div className="flex items-start gap-3">
										...
										<span className="text-gray-700 text-sm sm:text-base"><strong>Experience:</strong> {job.experience}</span>
									</div>
									<div className="flex items-start gap-3">
										<Award className="w-5 h-5 text-[#36AC43] flex-shrink-0 mt-0.5" />
										<span className="text-gray-700 text-sm sm:text-base"><strong>Education:</strong> {job.education}</span>
									</div>
									<div className="flex items-start gap-3">
